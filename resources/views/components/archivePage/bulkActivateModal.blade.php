<div x-data="{
    ...
    @open-bulk-activate-modal.window="
...
"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-900 w-[30rem] max-h-[90vh] overflow-y-auto"
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Activate Multiple Accounts</h2>
        ...
        <div class="px-6 py-6">
            <div class="flex items-start gap-4">
                ...
                <!-- Message -->
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100 mb-2">Activate these accounts?
                    </h3>
                    <p class="text-gray-600 dark:text-gray-400">
                        Are you sure you want to activate <strong x-text="count"></strong>
                        <span x-text="count === 1 ? 'account' : 'accounts'"></span>?
                        <span x-show="count === 1">This account</span>
                        <span x-show="count > 1">These accounts</span>
        ...
        <div class="px-6 py-4 border-t border-gray-200 dark:border-gray-700 flex justify-end gap-3">
            ...
            <button type="button"
                @click="
                $wire.bulkActivate(userIds);
                show = false;
                $dispatch('bulk-action-completed', { action: 'activate', activatedIds: userIds });
            "
