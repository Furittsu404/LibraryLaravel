<div x-data="{
    ...
    @open-delete-login-modal.window="
    loginId = $event.detail.id;
    userName = $event.detail.name;
    loginTime = $event.detail.time;
    show = true;
"
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg dark:shadow-gray-900 w-[30rem] max-h-[90vh] overflow-y-auto"
        ...
        <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700 flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Delete Login Record</h2>
            ...
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 mb-4">
                        You are about to permanently delete the login record for <span
                            class="font-semibold text-gray-900 dark:text-gray-100" x-text="userName"></span>
                        at <span class="font-semibold text-gray-900 dark:text-gray-100" x-text="loginTime"></span>.
                    </p>
                    <p class="text-sm text-red-600 dark:text-red-400 font-semibold">
                        ⚠️ This action cannot be undone. The login record will be permanently deleted from the database.
                    </p>
                </div>
            </div>
        </div>
