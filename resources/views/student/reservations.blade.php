                            ...
                            <div class="space-y-6">
                                ...
                                <div class="border-t-2 border-gray-200 pt-6 mt-6">
                                    <div class="flex items-center justify-between mb-4">
                                        <label class="flex items-center gap-2 text-sm font-semibold text-gray-700">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                ...
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                                    d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m.94 3.198.001.031c0 .225-.012.447-.037.666A11.944 11.944 0 0 1 12 21c-2.17 0-4.207-.576-5.963-1.584A6.062 6.062 0 0 1 6 18.719m12 0a5.971 5.971 0 0 0-.941-3.197m0 0A5.995 5.995 0 0 0 12 12.75a5.995 5.995 0 0 0-5.058 2.772m0 0a3 3 0 0 0-4.681 2.72 8.986 8.986 0 0 0 3.74.477m.94-3.197a5.971 5.971 0 0 0-.94 3.197M15 6.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0" />
                                            </svg>
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="number" x-model.number="participant_count"
                                            @input="updateParticipantFields()" min="0" max="40"
                                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm"
                                            placeholder="Enter number of participants (0-40)">
                                        <p class="text-xs text-gray-500 mt-2">Leave at 0 if you're reserving alone</p>
                                    </div>

                                    {{-- Participant Fields (shown when count > 0) --}}
                                    <div x-transition class="space-y-3 max-h-96 overflow-y-auto pr-2">
                                        <template x-for="(participant, index) in participants" :key="index">
                                            <div
                                                class="bg-gray-50 p-4 rounded-lg border-2 border-gray-200 hover:border-green-300 transition-colors">
                                                <div class="flex items-center justify-between mb-3">
                                                    <span class="text-sm font-semibold text-gray-700"
                                                        x-text="`Participant ${index + 1}`"></span>
                                                    <button x-show="participant_count > 0"
                                                ...
                                                <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
                                                    <div>
                                                        ...
                                                        <input type="text" x-model="participants[index].name"
                                                            required placeholder="Full Name"
                                                            class="w-full px-3 py-2 text-sm border-2 border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 transition-all shadow-sm">
                                                    </div>

                                                    <div>
                                                        <label class="block text-xs font-medium text-gray-600 mb-1">
                                                            Student/School ID <span
                                                                class="text-gray-400">(Optional)</span>
                                                        </label>
                                                        <input type="text" x-model="participants[index].id"
                                        ...
                                        <button x-show="participant_count < 40" @click="addParticipant()"
                                            type="button"
                                            class="w-full px-4 py-3 border-2 border-dashed border-gray-300 text-gray-600 rounded-lg hover:border-green-500 hover:text-green-600 transition-colors flex items-center justify-center gap-2">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none"
